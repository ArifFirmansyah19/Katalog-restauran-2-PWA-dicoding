...
const createRestaurantItemTemplate = (restaurant) => `
  <div class="restaurant-item">
    <img class="restaurant-img" src="${CONFIG.IMAGE_URL.SMALL + restaurant.pictureId}" alt="${restaurant.name}">
...
<div class="container-detail">
    <img class="restaurant__img" src="${CONFIG.IMAGE_URL.LARGE + restaurant.pictureId}" alt="${restaurant.name}" />
